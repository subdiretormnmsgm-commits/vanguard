...
1. Loop 33 fecha sem tocar skill externa
1. V33+: começar por UMA skill — `skillify`
1. As demais do TIER 1 apenas depois de skillify provar valor
1. TIER 2 (Antigravity): só quando o build correspondente abrir
