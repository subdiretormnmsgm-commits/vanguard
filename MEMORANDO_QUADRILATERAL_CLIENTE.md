# MEMORANDO QUADRILATERAL — PROTOCOLO MESTRE PARA PROJETOS DE CLIENTE
**Vanguard Tech · IAH — Inteligência Artificial Humana**
**Classificação:** Confidencial Operacional
**Versão:** 1.0 — baseada em 23 versões de aprendizagem interna
**Data de emissão:** 2026-05-10
...
**Regra de ouro:** A sequência é obrigatória — mas dentro de cada fase os membros interagem, debatem e desafiam uns aos outros. O Quadrilateral não é uma linha de montagem; é um conselho que delibera.
...
**Quando:** Antes de qualquer conversa com o Quadrilateral
