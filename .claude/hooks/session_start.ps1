...
$colheitaCowork = @(
    ...
    "     b. Extrair: frente (F1/F5/F7/etc), data, 3 bullets do sinal mais urgente",
    "     c. Renomear adicionando prefixo [LIDO] ao nome (copy_file + delete original)",
    "  4. Apresentar ao Diretor no formato EXATO:",
    "     COLHEITA DO EMBAIXADOR -- [N] arquivo(s) novo(s)",
    "     [F1] [nome da frente] - [data]:",
    "       bullet 1 - sinal mais urgente",
    "       bullet 2",
    "       bullet 3",
    "     [F5] [nome da frente] - [data]:",
    "       bullet 1",
    "       bullet 2",
    "       bullet 3",
    ...
    "  - NAO executar as frentes F1-F15 (sao do Cowork, nao do Musculo)",
