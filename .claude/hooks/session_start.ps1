...
$colheitaCowork = @(
    ...
    "",
    "━━━ [3] ARTIFACT ENGINE -- COWORK NAO TERMINA EM LISTA, TERMINA EM ACAO (bloqueante) ━",
    "  Executar APOS a COLHEITA. Nao pular. Nao simplificar para 'deliberacao'.",
    "",
    "  CAMADA 1 -- CONVERGENCIA (automatica):",
    "    Cruzar todos os sinais lidos nas frentes.",
    "    Sinal aparece em 2+ frentes = SINAL VALIDADO (nao ruido).",
    "    Sinal em 1 frente = SINAL CANDIDATO (monitorar).",
    "    Exibir: 'SINAIS VALIDADOS: [lista] | CANDIDATOS: [lista]'",
    "",
    "  CAMADA 2 -- MATCH COM REALIDADE VANGUARD:",
    "    Para cada SINAL VALIDADO, cruzar com:",
    "      - WIP_BOARD.json: clientes ativos, verticais, nichos em build/check/retainer",
    "      - INTELLIGENCE_HUB/PENDING_REVIEW.md: sinais ja registrados",
    "      - .claude/skills/vanguard-v*.md: verticais existentes no sistema",
    "    Classificar cada sinal:",
    "      [OPORTUNIDADE NOVA]      -- nicho inexistente no portfolio",
    "      [EXPANSAO CLIENTE ATIVO] -- sinal afeta Valdece/Ingrid diretamente",
    "      [CONFIRMA VERTICAL]      -- reforça nicho ja existente",
    "      [NOVO NICHO]             -- candidato a nova vertical Vanguard",
    "",
    "  CAMADA 3 -- ARTEFATO GERADO (objeto concreto, nao opiniao):",
    "    Por classificacao -- o Musculo GERA o artefato, nao propoe gerar:",
    "      [OPORTUNIDADE NOVA + urgencia MUITO ALTA]:",
    "        -> Gravar stub PASSO3_GEMINI em CLIENTES/VANGUARD/PASSO3_GEMINI_[nicho].md",
    "        -> Adicionar entrada em WIP_BOARD.board.discovery",
    "      [EXPANSAO CLIENTE ATIVO]:",
    "        -> Redigir mensagem WhatsApp/email pronta (copiar e enviar)",
    "        -> Formato: texto completo, nao esboço",
    "      [CONFIRMA VERTICAL]:",
    "        -> Adicionar fonte ao INTELLIGENCE_HUB/PENDING_REVIEW.md",
    "        -> Atualizar campo de evidencias da vertical no skill do cliente",
    "      [NOVO NICHO]:",
    "        -> Criar entrada estruturada em INTELLIGENCE_HUB/PENDING_REVIEW.md",
    "        -> Proposta de Loop para o Diretor: 'Novo nicho [X] detectado -- abrir Loop?'",
    "",
    "  APRESENTACAO FINAL AO DIRETOR -- formato de decisao numerada:",
    "    ARTIFACT ENGINE -- [N] artefatos gerados",
    "    [1] [tipo] [descricao do artefato e acao proposta] -- APROVAR/EDITAR/DESCARTAR",
    "    [2] [tipo] [descricao] -- APROVAR/EDITAR/DESCARTAR",
    "    ...",
    "    Diretor responde: '1-APROVAR 2-EDITAR 3-DESCARTAR'",
    "    Musculo executa imediatamente os aprovados.",
    "",
    "  Musculo que apresenta lista de sinais sem gerar artefato = Cowork desperdicado.",
    "  O valor nao e a inteligencia coletada -- e a acao que ela dispara.",
    "",
    "━━━ REGRAS ABSOLUTAS ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━",
    "  - NAO executar frentes F1-F15 (Cowork faz isso, nao o Musculo)",
    "  - NAO criar copia local do SKILL_EMBAIXADOR (canonico no Drive)",
    "  - PENDENTES gerados aqui entram com data de hoje e tag [musculo]",
    "  - Artefatos gerados na Camada 3 sao RASCUNHOS -- Diretor aprova antes de enviar/publicar",
    "",
    "  ⛔ Musculo que solicita BLOCO 0 sem ter executado [1]+[2]+[3] = DEF-M-6 automatico.",
    "  ⛔ Musculo que apresenta lista de sinais sem artefato = PASSO 0 incompleto."
) -join "`n"
