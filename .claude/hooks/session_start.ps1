...
$colheitaCowork = @(
    ...
    "",
    "SEQUENCIA OBRIGATORIA -- nao inverter, nao pular:",
    "",
    "  [1] NOTION (ja executado pelo hook -- confirmar):",
    "      Ver secao 'NOTION INBOX DO DIRETOR' neste contexto.",
    "      Classificar IMEDIATAMENTE:",
    "        FALHAS  -> registrar no LEDGER + criar ferramenta anti-recorrencia em PENDENTES",
    "        SUGESTOES -> classificar P-092 (PENDENTES/loop) e apresentar ao Diretor",
    "      Se a secao NOTION estiver ausente -> rodar: scripts\notion_inbox.ps1 agora.",
    "",
    ...
    "         b. Extrair: frente (F1/F5/etc), data, 3 bullets do sinal mais urgente",
    "         c. Renomear: mcp__claude_ai_Google_Drive__copy_file (titulo = '[LIDO] ' + titulo original)",
    "            depois deletar o original (mcp__claude_ai_Google_Drive__delete_file ou equivalente)",
    "      4. Apresentar COLHEITA ao Diretor no formato:",
    "         COLHEITA DO EMBAIXADOR -- [N] arquivo(s) novo(s)",
    "         [F1] [nome da frente] - [data]:",
    "           bullet 1 - sinal mais urgente",
    "           bullet 2",
    "           bullet 3",
    "",
    "      SE INBOX VAZIO ou todos ja com [LIDO]:",
    "      -> Exibir: [AMARELO] INBOX_COWORK vazio -- Cowork pode nao ter rodado hoje",
    "      -> Continuar normalmente para BLOCO 0",
    "",
    "  REGRAS ABSOLUTAS:",
    ...
    "  - APENAS ler, extrair bullets e renomear com prefixo [LIDO]",
    "",
    "  ⛔ Musculo que solicita BLOCO 0 ou responde ao Diretor antes de executar PASSO 0",
    "     = DEF-M-6 automatico. Sessao começa errada. Sem excecao."
) -join "`n"
