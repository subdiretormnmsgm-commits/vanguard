...
4. APRESENTAR PLANO DE BUILD ao Diretor
   ...
   — Dia 3: o que vai ser construído exatamente
   — Dia 4: o que vai ser construído exatamente
   — Dia 5: o que vai ser construído exatamente (incluindo handoff)
...
6. AO FECHAR O BUILD (Dia 5):
   — MEMORIA_V2_VALDECE.md com tudo que foi construído
   — relatorio_evolutivo_V2_VALDECE.md com análise de negócio + 5 novas ideias
   — PASSO3_GEMINI_PRÓXIMO_CICLO.md pronto para Eduardo levar ao Gemini
