...
def search(query: str, top_k: int = 5, threshold: float = 0.65) -> list[dict]:
...
def main():
    ...
    parser.add_argument("--threshold", type=float, default=0.65, help="Similaridade mínima (padrão: 0.65)")
