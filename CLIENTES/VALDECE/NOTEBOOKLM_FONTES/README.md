...
ANTES de ir a uma reunião com cliente potencial
  → DISCOVERY_CARD.md (levar no celular ou impresso)

DURANTE o projeto (operação diária)
  → MANUAL_DIRETOR.md (guia passo a passo com comandos prontos)

AO ativar o Claude Code
...
5. Ao ativar o Claude Code, referenciar `SKILL_PROTOCOLO_VANGUARD.md`
6. Ao lançar, ativar o `ROI_TRACKER_TEMPLATE.md` para verificação em 30 dias
...
## Protocolo de atualização — Organismo Vivo
...
| `PERFIL_CLIENTE_TEMPLATE.md` | Nova seção útil descoberta · Campo que nunca é preenchido (remover) |
| `ROI_TRACKER_TEMPLATE.md` | Dados reais de ROI muito diferentes das estimativas · Pergunta ao cliente que gerou mais contexto |

O Claude pode atualizar qualquer destes documentos diretamente — basta pedir ao fechar a iteração.
...
| Manual do diretor | 1.2 | 2026-05-11 |
