...
### [P-053] Isolamento multi-camada de Persona por Nicho — 4 camadas independentes
**Descoberto:** 2026-05-19 | **Proposto por:** Auditor (NotebookLM) — AUDITORIA_MEDICINA_V2 [DIV-A] · **Expandido por:** Embaixador — REACAO_EMBAIXADOR_AO_AUDITOR | **Sessão:** Nicho Medicina — Loop 3.5
**Evidência:** PERFIL_EDTECH_CONCURSO (Ingrid) = tom caloroso, motivacional, linguagem não-técnica — "Oi, tudo bem 🙂" e onboarding motivacional. PERFIL_MEDICINA_R3 = tom austero, técnico-clínico, sem encorajamento. O mesmo motor SM-2 + Tutor Socrático subjaz a ambos. A contaminação de tom não se limita ao Tutor — alcança mensagens do Embaixador ao cliente, roteiro de onboarding e linguagem do Termo de Uso. Aplicar configuração Ingrid a médico R3 = churn no Dia 1 em múltiplas camadas.
**Princípio:** Cada novo nicho com perfil comportamental distinto exige isolamento de tom em **quatro camadas independentes**: (1) system prompt do Tutor Socrático — tom do produto, (2) templates de mensagens do Embaixador ao cliente — tom relacional, (3) roteiro de onboarding — linguagem de apresentação do produto, (4) Termo de Uso — linguagem jurídica adequada ao perfil (CFM/LGPD para Medicina; OAB para Direito; CFC para Contabilidade). Reutilizar qualquer das quatro entre nichos contamina a percepção de prestígio e adequação.
**Rotina operacional:** Checklist de Comando de Propagação: □ novo system prompt criado (não copiado) □ sentinel_config.json bifurcado com parâmetros do nicho □ Claude Project do Embaixador criado do zero □ templates de mensagens reescritos para tom do nicho □ Termo de Uso forkado com cláusulas regulatórias do nicho.
