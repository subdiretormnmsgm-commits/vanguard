...
[COLAR AQUI O CONTEÚDO COMPLETO DA MEMORIA_V[X].md]

────────────────────────────────────────────
RELATORIO_V[X] — VISÃO DO MÚSCULO
────────────────────────────────────────────
...
1. [ideia 1] — lógica: [razão técnica] — concordas? tens alternativa melhor?
...
────────────────────────────────────────────
O QUE PRECISO DE TI (5 BLOCOS OBRIGATÓRIOS)
────────────────────────────────────────────
...
3 entregas em ordem de impacto comercial imediato.

BLOCO 2 — PROPOSTA COMERCIAL
ROI em linguagem do cliente (não em jargão técnico).
Preço, prazo, argumento de valor.
