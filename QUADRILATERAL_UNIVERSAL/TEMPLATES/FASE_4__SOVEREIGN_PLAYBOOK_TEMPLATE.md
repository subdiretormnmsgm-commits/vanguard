...
## COMO COMEÇAR (Primeiros 10 Minutos)

### Aceder ao sistema
1. Abra o browser e vá para: **[URL do sistema]**
2. Clique em "Entrar" e use o seu email e palavra-passe
...
### [Tarefa mais importante do dia — ex: "Ver os agendamentos de hoje"]
1. [passo 1]
2. [passo 2]
3. [passo 3]

### [Segunda tarefa mais comum]
1. [passo 1]
2. [passo 2]

### [Terceira tarefa mais comum]
1. [passo 1]
2. [passo 2]
...
## SE ALGO NÃO FUNCIONAR — GUIA DE TROUBLESHOOTING
...
### O sistema está lento ou inacessível
...
**O relatório é gerado automaticamente — não precisa de fazer nada.**

Se quiser mudar o email de destino ou o dia do envio, contacte-nos.

---

## COMO PEDIR A PRÓXIMA EVOLUÇÃO

Quando quiser melhorar o sistema, adicionar funcionalidades, ou resolver algo que não está a funcionar como esperava:
...
Informe:
1. O que gostava de mudar ou adicionar
2. Por que é importante para o seu negócio
3. Com que urgência precisa

---

## CUSTOS MENSAIS DO SISTEMA

| Serviço | Custo mensal | Renovação |
|---------|-------------|-----------|
| [Serviço 1 — ex: Hospedagem] | R$[X]/mês | [data de renovação] |
| [Serviço 2 — ex: Base de dados] | R$[X]/mês | [data] |
...
2. Email: [email do operador] | WhatsApp: [número]
