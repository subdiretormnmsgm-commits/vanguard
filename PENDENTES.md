...
- [ ] `2026-06-23` **[MÚSCULO] F3 N18 — corte de porte de hospitais-alvo p/ fechar a convergência do SAM (camada fria M-STATS)** [musculo] (autorizado pelo Diretor 2026-06-23 "3-SIM F3" · rodar na consolidação de **Sexta** 26-06-2026 conforme GATE DE DATA Cowork)
  Origem: SAÍDA_PROJETISTA 2026-06-23 — o SAM de N18 (saúde-digital/conformidade) fechou **NÃO-convergido** (Market Sizing dupla-via fora da regra dos ±15%) e entrou no PLANO como **faixa declarada** (P-197). Recomendação do Projetista, autorizada pelo Diretor: estreitar a faixa via **corte de porte de hospitais-alvo** (segmentar o universo de hospitais privados BR por porte/nº de leitos → recalcular SAM com taxa de adoção por estrato). **GATE DE ENTRADA do `market-stats-analysis` (não negociável):** exige fonte verificável (URL+data) do nº de hospitais privados por porte/leitos no Brasil (candidatos: CNES/DataSUS, ANS, IBGE/IESS) — **sem fonte → BLOQUEIO, não fabricar**. Dupla-via top-down × bottom-up; só publica se convergir ±15%; senão registra o gap e mantém a faixa. Saída → `INTELLIGENCE_HUB/PENDING_REVIEW.md` (AGUARDANDO_VEREDITO, P-124) → realimenta o PLANO N18 v1. Plano: `PENTALATERAL_UNIVERSAL/INTELLIGENCE_HUB/PROJETISTA/PLANOS/PLANO_EXECUCAO_N18_saude-digital_v1.md`. [RESOLVE: f3-n18-corte-porte]

- [ ] `2026-06-24` **[DIRETOR] ESTUDAR DEPOIS — Integração Webhooks n8n ↔ LinkedIn (Sugestão do Dia, Notion)** [diretor] (24-06-2026 quarta-feira · Diretor: "estudar depois")
  Origem: child page "💡 Vanguard - Sugestões do Dia" (Notion), item 4. Itens 1-3 já ✅ PROCESSADO (W-13 session log · W-13 Cowork F(x) Notifier · W-10 Health Check estendido). Item 4 = ideia estratégica de integração entre os webhooks do n8n e o LinkedIn (canal/Company Page). Veredito do Diretor: NÃO executar agora — **estudar depois**. Reabrir quando o Diretor priorizar (entra como insumo de objetivo de Loop ou ação de canal). Não é tarefa mecânica do Músculo. [RESOLVE: integracao-webhooks-linkedin]

- [ ] `2026-06-24` **[MÚSCULO] TESTAR TODOS os notifiers no novo horário — rodar `auditoria_fuso_n8n.ps1` amanhã (25-06)** [musculo] (25-06-2026 quinta-feira · Diretor: "teste todos depois")
  Origem: hoje 24-06 corrigi via API os crons de W-10 (`30 9`→`30 6`), W-12 (`10 10`→`10 7`), W-13 (`15 10`→`15 7`) — bug de fuso (+3h) que não fora propagado do W-11. As execuções de HOJE ainda foram no horário velho; a prova final só vem **depois** que dispararem no novo horário. AÇÃO amanhã: `.\scripts\auditoria_fuso_n8n.ps1` → deve dar **VERDE** nos quatro (W-10 06:30 · W-11 07:05 · W-12 07:10 · W-13 07:15 BRT). Se algum ainda acusar deriva → o cron não pegou; reabrir. Auditor criado hoje (P-146 anti-recorrência: o Health Check não detecta fuso porque status=success). [RESOLVE: testar-notifiers-fuso]
...
- [ ] `2026-06-20` **[DIRETOR] LINK SITE ↔ COMPANY PAGE — resolver o mismatch antes de o canal ir ao ar** [diretor] — PRÓXIMA SESSÃO (casa com A2)
  O campo "Site" da Company Page do LinkedIn aponta (ou apontará) para **vanguardtech.cloud**, que hoje é a Vanguard v1 (agência digital para PMEs, ticket baixo, conteúdo de quiz/WhatsApp). A Company Page ancorará o nicho regulatório (AI Act, autoridade, ticket alto). Se o prospect clicar no link esperando autoridade regulatória e cair na landing de diagnóstico digital → **a esteira quebra no destino**. DECISÃO a tomar: (a) MIRAR o site existente (superfície de atração para o nicho elevado — decisão 2 do CONTEXTO: orientar, nunca reconstruir) vs (b) página/seção dedicada vs (c) deixar o campo "Site" vazio até a superfície mirada existir. Conecta com A2 (localizar a pasta-fonte do vanguardtech.cloud + diagnosticar o `www` construído-mas-fora-do-ar). [RESOLVE: link-site-company-page]

- [x] `2026-06-20` **[DIRETOR] ABORDAGEM AO CLIENTE — o Quiz/Diagnóstico ainda é o destino certo? (a inteligência já entrega a dor)** [diretor] ✅ DECIDIDO (verificado em disco 2026-06-23) — a deliberação JÁ foi resolvida e implementada: o veredito do Diretor (2026-06-20, memória `feedback_funil_dna_mira_ingrid_valdece`) fixou o funil INTELIGÊNCIA → SITE/LINKEDIN mirados → QUIZ (captura a dor) → LOOP; e o branch SITE DUPLA-ENTRADA (item logo abaixo, COMPLETO) materializou exatamente a resposta: porta orgânica (quiz DNA intacto) + porta de inteligência por origem (`?nicho=<slug>`). O Quiz vira porta orgânica/marca-ampla; a porta de nicho é a entrada dirigida. DNA não mudou. Ficou aberto por falha de higiene de backlog — não por decisão pendente. [RESOLVE: abordagem-pos-inteligencia]
  Insight do Diretor (2026-06-20): no funil desenhado, o destino do canal era QUIZ/DIAGNÓSTICO → LOOP. Mas quando é a **inteligência de mercado** que nos leva ao nicho, **já chegamos ao cliente conhecendo a dor** — o nicho regulatório (AI Act) JÁ É a dor. Logo o Quiz, que servia para DESCOBRIR a dor, pode ser redundante ou ter outra função. **A abordagem deve ser diferente:** talvez chegar com autoridade/solução do nicho (não com diagnóstico genérico), e o LOOP Pentalateral monta o projeto a partir da dor já mapeada (DNA intacto — como Ingrid/Valdece). Deliberar na próxima sessão: o Quiz vira (a) qualificador/segmentador dentro do nicho, (b) ponte de captura de WhatsApp só, (c) substituído por uma abordagem de autoridade direta, ou (d) mantido para entrada de marca-ampla (não-nicho). DNA não muda — a **porta de entrada** muda quando a mira é dirigida. Casa com `[[feedback_funil_dna_mira_ingrid_valdece]]`. [RESOLVE: abordagem-pos-inteligencia]

- [x] `2026-06-20` **[DIRETOR] PENDING_REVIEW Vibehub/Lasy AI — 4 ações do Embaixador aguardam veredito** [diretor] ✅ VEREDITADO 2026-06-23: "1-SIM meta R$5000 · 2-SIM · 3-SIM · 4-TERMÔMETRO" — EXECUTADO (W-14 no WIP_BOARD · frame em ESTRATEGIA_CANAIS+INTENCAO_LINKEDIN rascunho · AÇÃO 3 COMANDO Embaixador Digital preparado · MVA como TERMÔMETRO no DISCOVERY_CARD). PF-1 NÃO wired (aposentado).
  Bloco completo gravado em `PENTALATERAL_UNIVERSAL/INTELLIGENCE_HUB/PENDING_REVIEW.md` (topo, AGUARDANDO VEREDITO). Resumo: (1) **KPI Human-to-Revenue Ratio** → W-14 no WIP_BOARD (MRR R$5k ÷ 2 = R$2.500/pessoa; meta alvo aguarda Diretor; aciona PF-1 quando loop só faz build) · (2) **frame de pitch** em ESTRATEGIA_CANAIS + INTENCAO_LINKEDIN: "orquestração governada"→"crescimento sem headcount proporcional, com auditoria embutida" · (3) **hook novo** no próximo post LinkedIn (Embaixador Digital redige → Auditor valida NICHE_INDEX) · (4) **critério MVA** no BLOCO A de qualificação ("prospect sem processo documentado não entra"). ⚠️ Tensão a deliberar: AÇÃO 4 (MVA) vs DNA dor→Loop (Ingrid/Valdece entraram pela dor, não por processo mapeado) e vs abordagem pós-inteligência. Cada ação aguarda veredito ANTES de qualquer execução. [RESOLVE: pending-review-vibehub]

- [x] `2026-06-20` **[DIRETOR] DETECTOR DE DERIVA — decidir cadência da camada semântica + destino canônico dos achados** [diretor] ✅ DECIDIDO + IMPLEMENTADO (verificado em disco 2026-06-23): **P-196 no INTELLIGENCE_LEDGER** (linha 3003, 2026-06-21, [VEREDITO-DIRETOR]) registra DECISÃO 1 (cadência — camada semântica NÃO roda toda sessão: gatilho por mudança de DOUTRINA + rede de segurança quando determinístico ≥ AMARELO) e DECISÃO 2 (destino canônico ÚNICO = `INTELLIGENCE_HUB/PENDING_REVIEW.md` → seção `## DERIVA DOCUMENTAL`). Implementação confirmada: `detector_deriva.ps1` linhas 100-130 têm o gatilho de doutrina (`$doutrinaMudou` sobre LEDGER/CLAUDE.md/SKILL.md/PENTALATERAL_UNIVERSAL + fail-safe P-110) que aciona o subagente `doc-drift-audit`; CLAUDE.md (seção Detector de Deriva) documenta o comportamento operacional. (a) destino + (b) gatilho no script + (c) doutrina no LEDGER = feitos. [RESOLVE: detector-cadencia]
  DECISÃO 1 (cadência): Músculo defendeu **gatilho por mudança de doutrina** (LEDGER / CLAUDE.md / prosa de skill / PENTALATERAL_UNIVERSAL editados na sessão) **+ rede de segurança quando a determinística ≥ AMARELO + piso 1×/loop na fase ACT** — NÃO toda sessão. Razão: a camada determinística (`detector_deriva.ps1 -Leve`) já é o batimento de toda sessão a custo ~zero; rodar o subagente LLM toda sessão = custo + fadiga de alerta em `PENDING_REVIEW` + câmara de eco (re-deriva a mesma prosa estável).
  DECISÃO 2 (destino canônico dos achados): raiz `PENDING_REVIEW.md` (não existe hoje) **vs** `INTELLIGENCE_HUB/PENDING_REVIEW.md` (existe). Definir 1 só.
  CONTEXTO ESTRATÉGICO (Diretor 2026-06-20): Vanguard atuará MAIS em Cowork/Executor (inteligência de mercado); **Loops de cliente serão raros/difíceis agora** → o piso "1×/loop" quase não dispara, logo o gatilho por **mudança de doutrina + AMARELO** vira o mecanismo primário que mantém o Detector vivo.
  Após veredito: Músculo (a) cria o destino canônico, (b) escreve o gatilho no `detector_deriva.ps1`/`session_close`, (c) registra a doutrina no LEDGER. [RESOLVE: detector-cadencia]

- [ ] `2026-06-21` **[DIRETOR] SITE DUPLA-ENTRADA + VITRINE — testar as 2 portas localmente antes de qualquer deploy (HARD-GATE / P-124)** [diretor] (21-06-2026 domingo · NÃO fechar por RESOLVE/git — só o Diretor encerra após testar e aprovar)
  Branch `feature/vitrine-dupla-entrada` COMPLETO (15/15 tarefas, 16 commits, reviewer final = APROVADO_COM_RESSALVAS, zero críticos). Entrega: porta orgânica (quiz DNA Ingrid/Valdece intacto) + porta de inteligência por origem (`?nicho=<slug>`) + Vitrine dinâmica de nichos MOVER_AGORA (rank 1 = hero) + métrica-mãe (lead grava `origem`+`nicho`). Regen sob date-gate no `CALENDARIO_NICHE_INTELLIGENCE.md` (02/07, 02/08, 02/09). Antes do merge/deploy: Diretor abre o `index.html` local e testa (a) entrada orgânica `/` → quiz descobre a dor; (b) entrada de inteligência `/?nicho=<slug>` → Vitrine + quiz; (c) Vitrine some quando não há nicho servido. Só após aprovação → merge + deploy Hostinger (deploy adiado pós-V20; após F2 o shell vive em `ACERVO_VANGUARD/PWA/` — ajustar `local-dir`/`server-dir` no workflow se reativar). [RESOLVE: site-dupla-entrada-teste]

- [x] `2026-06-21` **[DIRETOR] SITE V2 — quiz-por-nicho renderizado (spec §3) DIFERIDO para spec/plan próprios** [diretor] ✅ DECISÃO DE DIFERIR CONFIRMADA (verificado em disco 2026-06-23) — ⚠️ LEITURA HONESTA: o V2 **NÃO foi construído**. O substrato de dados existe (`buildNicheQuiz` gera `niches[].quiz`, testado), mas a RENDERIZAÇÃO do quiz-por-nicho no frontend continua diferida (grep confirma: `buildNicheQuiz` só aparece em cópias do LEDGER, não no JS do site). O que está "feito" é a **decisão de diferir** (Diretor 2026-06-21) — não há ação pendente do Diretor. Fecho o item-DECISÃO; o BUILD do V2 fica como backlog dormente, reabrível quando o Diretor priorizar (spec → plan dedicados a partir do substrato pronto). [RESOLVE: site-v2-quiz-nicho]
  Veredito do Diretor (2026-06-21): **V2 diferido**. A spec §3 (quiz específico do nicho, derivado de `dores[]`, com mini-página/UX própria) NÃO entra na entrega atual. O substrato de dados já existe e está pronto: `buildNicheQuiz` gera `niches[].quiz` dentro de `niches_public.json` (testado), aguardando consumo no frontend. A entrega atual (entrada dupla por origem + Vitrine + métrica-mãe) é completa, deployável e já mede conversas reais por nicho — o card linka para o quiz genérico `?nicho=<slug>#quiz`. Quando o Diretor priorizar V2: abrir spec → plan dedicados para renderizar o quiz-por-nicho a partir do substrato já existente. [RESOLVE: site-v2-quiz-nicho]

- [x] `2026-06-17` **[MÚSCULO] OPERAÇÃO VAULT SOBERANO — plano cirúrgico de 7 fases pronto para arranque** [musculo] (quarta-feira) ✅ CONCLUÍDA 2026-06-17
  ...
  PROGRESSO: F0 ✅ · F1 ✅ (`vault_audit.ps1` + VAULT_MANIFEST/REPORT, commit 7afb987, drift canônico=0) · F2 ✅ 2026-06-17 (veredito B1-B4 do Diretor: lixo removido, higiene→`_ARQUIVO/`, código-produto V1-V24→`ACERVO_VANGUARD/` indexado preservado; `knowledge_graph.json`+`utils/` mantidos vivos na raiz via review R-05; INFRA viva e docs soltos diferidos p/ F3) · F3 ✅ 2026-06-17 (veredito A-SIM B-SIM C-SIM D(SUGESTOES→CONSELHO, INSTRUCAO_SISTEMA→docs) F-SIM E-NÃO: ~14 docs soltos relocados [CONSELHO/ · CONTEXTO_DIRETOR/ · docs/], `SUGESTOES_DIRETOR.md`→canônico CONSELHO/, `INFRA_INDEX.md` gerado; INFRA viva NÃO movida — escopo narrow por risco de deploy). Item 14 (`INSTRUCAO_AUTOMACAO_ABERTURA_FECHAMENTO.md`) resolvido → `docs/` (mesmo critério do INSTRUCAO_SISTEMA, sem sync). · F4 ✅ 2026-06-17 (veredito G-SIM H-SIM I-SIM J-NÃO: 13 prosa `.txt`→`.md`; G corrigiu gap F3 — 6 prosa da raiz escapados por acento → `CONTEXTO_DIRETOR/`; dados/config/template/ingestão MANTIDOS `.txt` por ref de script; histórico CONSELHO/VANGUARD_HISTORICO diferido J-NÃO). · F5 ✅ 2026-06-17 (veredito 1-SIM 2-SIM 3-SIM 4-SIM 5-a 6-SIM 7-SIM — CORRIGIDO na execução: A+E feitos, B/C/D PULADOS por achado de disco). Bloco A: 3 `.bak` strays→`_ARQUIVO/BAK/` (`WIP_BOARD.md` preservado=input vivo notion_sync). Bloco E: verify hash GREEN dos 3 clientes EM USO (VANGUARD/VALDECE/INGRID = base completa+idêntica; relatório em `_ARQUIVO/SYNC_REPORTS/`). B/C/D pulados: ausência de docs base em MUMUZINHO/STANDBY é CURADORIA (cliente parado/discovery-standby gate Dudu Félix 04-07), não lacuna de sync; `CLIENTES/STANDBY/` é estacionamento de projetos parados (não template) → preservado intacto (5-c). Premissa "adaptação contextual profunda" fica com loops de cliente, fora do Vault. · F6 ⏳ VERIFICADO 2026-06-17 (veredito F6-DEFERIR): mirror Drive já cabeado no Gate 10 (`session_close.ps1:651` + auto-sync P-169). Dry-run read-only com filtro P-185 confirmou: 288 copy / 1 update / 270 delete (caminhos antigos da reorg = outro lado dos `git mv`, não perda; git é a rede de segurança) e **0 segredos transferidos** (checagem explícita `.env`/`CHAVES`/`N8N`/`settings.local` VAZIA). Bônus: mirror limpa arquivo-lixo de nome corrompido no Drive. **PUSH REAL deferido ao próximo Gate 10 (session_close)** — C1 estrito, não rodar mid-sessão. Doc: `VAULT_F6_PROPOSTA.md`. Próximo e ÚLTIMO: F7 Detector de Deriva (fecha guarda-chuva #11). · **F7 ✅ 2026-06-17 (veredito 1-SIM 2-b-min 3-c-1 4-SIM 5-DIFERIR 6-SIM): DETECTOR ATIVO.** Achado central: o Detector já existia disperso → F7 ATIVOU, não construiu. `scripts/detector_deriva.ps1` (b-min maestro orquestra 5 motores determinísticos, semáforo 0/1/2, read-only/LOCAL-FIRST) + briefing read-only no `session_start.ps1` (c-1, `-Leve -Quiet`, fault-tolerant, só exibe se exit≥1) + Detector registrado como ATOR COADJUVANTE no CLAUDE.md (detecta, nunca corrige, P-124). Prova-de-vida (Bloco F): 4 derivas REAIS pegas na 1ª varredura → `PENDING_REVIEW.md` (F7-01 Timelines defasadas MÉDIA · F7-02 persona §7 cita MAPA_VAULT inexistente MÉDIA · F7-03 zona-cinza P-059 3 docs Intelligence Hub MÉDIA · F7-04 sem read-guard credenciais BAIXA). Obsidian DIFERIDO como camada visual (Bloco E). **OPERAÇÃO VAULT SOBERANO ENCERRADA — guarda-chuva #11 fechado.** Doc: `VAULT_F7_PROPOSTA.md`.
  ⚠️ CAVEAT F2 (review R-05): `.github/workflows/deploy-hostinger.yml` (trigger MANUAL) espera o shell PWA na raiz; após F2 ele vive em `ACERVO_VANGUARD/PWA/`. NÃO afeta o loop autônomo (deploy público adiado pós-V20). Se reativar Hostinger → ajustar `local-dir`/`server-dir` para `ACERVO_VANGUARD/PWA/`.
...
- [x] `2026-06-15` ~~**[MÚSCULO] P-166 — gemini_anchor_generator.ps1: injetar PAPEL + ARSENAL DE SKILLS no comando ao Antigravity**~~ [musculo]
  ✅ Concluído (2026-06-16). Param `-papel` (ValidateSet ESTRATEGISTA/EXECUTOR/COWORK, default ESTRATEGISTA) + `$arsenalMap` PAPEL→{skills,fronteira} (P-163). O comando ao Antigravity agora SEMPRE contém: (1) "Sessao Antigravity: [PAPEL]", (2) arsenal exato na ordem (ESTRATEGISTA=@concise-planning→@brainstorming→@architecture→@analyze-project→7 pontos · EXECUTOR=@systematic-debugging,@bash-scripting,@git-pushing,@error-detective · COWORK=@bash-scripting,@error-detective) + nota "@concise-planning obrigatória em qualquer papel", (3) fronteira do papel (ESTRATEGISTA não gera DIRETRIZ autônoma; output→PENDING_REVIEW P-124; papéis não se misturam). Corpo da instrução adapta por papel via switch. Rótulo de exibição dinâmico ($papel). Parse 0 erros, logic testada 3/3 papéis (papel+arsenal=True), ASCII puro (P-183), validate_scripts sem erro crítico. [RESOLVE: P-166]
...
- [x] `2026-06-15` ~~**[MÚSCULO] P-178 — gate_code_review.ps1: code-review EXECUTADO nos arquivos de código modificados na sessão**~~ [musculo]
  ✅ Concluído (2026-06-16). `scripts/gate_code_review.ps1` já existia e cobre (a) filtro de extensões (.ps1/.psm1/.js/.html/.py/.css...) + .json só de infra (NUNCA .md de conteúdo, NUNCA dados de cliente P-059, via Test-CodeFile), (b) hash do blob → exit 1 + lista, (c) escopo só da sessão (staged+unstaged+untracked), (d) `-MarkReviewed` grava a flag após a skill `requesting-code-review`. WIRE das 3 camadas completo: **session_start** `-List` (aviso de abertura) + **pre-commit R-05** `-Verify` (bloqueio em commit-time, comprovado no e3abe0f) + **NOVO GATE 6E no session_close.ps1** (ENFORCEMENT no fechamento, exit 2, com bypass `PENTALATERAL_AUTORIZO` igual ao R-05). BUG ENCONTRADO E CORRIGIDO na revisão inline (sem subagente): `-List`/`-Report` só checavam `ContainsKey` (presença), não o hash — código revisado num commit e re-modificado depois passava como "já revisado" (falso-negativo); adicionado `Get-WorktreeSha` (git hash-object) → ambos agora sha-aware. Parse 0 erros nos 3 scripts, ASCII puro (P-183), validate_scripts sem erro crítico, `-List` testado ao vivo (re-detecta os re-modificados), lógica do bypass testada. [RESOLVE: P-178]

- [x] `2026-06-16` ~~**[MÚSCULO] P-184 — fechar as superfícies não cobertas do firewall P-098 (shell-install + incerteza no PreToolUse de Edit)**~~ [musculo]
  ✅ COMPLETO (2026-06-16, commit e3abe0f): (a) ✅ `.claude/hooks/shell_protection_guard.ps1` (PreToolUse Bash, wired) bloqueia gravação shell em caminho protegido (`>` redirect, `curl -o`, `tee`, `dd of=`, `mv`/`cp` destino, params PS `-Path`/`-Destination`); leitura (cat/grep) nunca bloqueia; autoriza via `.musculo_autorizacao.flag` ou `[VEREDITO-DIRETOR]`; FAIL-OPEN — testado 11/11. (b) ✅ lista canônica `.claude/hooks/protected_paths.txt` (fonte única dos 2 guards, fallback inline = firewall não enfraquece); `file_protection_guard.ps1` refatorado para lê-la; teste determinístico 3/3 PROVA que a flag é CONSUMIDA num Write real (antes=True→depois=False) E reconfirmado ao vivo na gravação do LEDGER (1ª edição consumiu a flag, 2ª BLOQUEADA — incerteza da Falha 2 resolvida). (c) ✅ P-184 registrado no INTELLIGENCE_LEDGER (linha "Ferramentas (P-146) [CONSTRUIDO 2026-06-16]") via VEREDITO do Diretor. validate_scripts sem erro crítico. [RESOLVE: P-184]
...
- [ ] `2026-06-20` **[DIRETOR] BASE LEGAL `compliance-aduaneiro-ncm` — confirmar antes de qualquer disparo do Embaixador Digital** [diretor] (sábado, madrugada · NÃO fechar por RESOLVE/git — só o Diretor encerra)
  Campanha Projetista gravada e PRONTA em `PENTALATERAL_UNIVERSAL/INTELLIGENCE_HUB/PROJETISTA/CAMPANHA/compliance-aduaneiro-ncm_CAMPANHA_v1.md`, porém RETIDA pela flag `[base legal a confirmar antes do disparo]`. Antes de o material sair para canal externo, o Diretor precisa confirmar por fonte jurídica citável: (1) LC 227/2026 · (2) "R$ 20.000 por informação incorreta" · (3) rejeição automática da NF na SEFAZ. M-STATS confirma o dimensionamento de mercado, NÃO o dispositivo legal. Gravar ≠ disparar — despacho ao Embaixador Digital só após esta confirmação. (Veredito Diretor 2026-06-19.)

- [ ] `2026-06-20` **[DIRETOR] AVALIAÇÃO `awesome-claude-skills` — shortlist de skills com fit no Pentalateral** [diretor] (sob demanda, sem deadline)
  Biblioteca de terceiros (1.142 arq) clonada intencionalmente pelo Diretor em 2026-06-19 (14:48) para `.claude/skills/awesome-claude-skills-master/`. Excluída do rclone (exclude ativo em `verify_gdrive_freshness.ps1`) e do git — vive só no disco, avaliação futura. Quando o Diretor pedir: Músculo gera shortlist das skills com aderência real ao processo Vanguard. Resíduo no Drive (arquivos que subiram antes do exclude) = lixo inerte, limpeza opcional 1 comando.
...
- [x] `2026-06-20` ~~**[MÚSCULO] LEDGER — registrar [FALHA-PROCESSO-2026-06-20]: GATE 10 do session_close.ps1 sincronizava sem o filtro de segredos**~~ [musculo] ✅ P-191 registrado (veredito Diretor 2026-06-20)
  Achado (sábado, madrugada): o GATE 10 do `session_close.ps1` chamava `rclone sync` para `gdrive:vanguard` SEM `--exclude-from rclone_secrets_exclude.txt` e SEM o exclude da `awesome-claude-skills-master` — só excluía `.git/.playwright-mcp/.serena/node_modules/*.pyc`. Era o gêmeo inseguro do sync de `verify_gdrive_freshness.ps1` (que tem os dois excludes). O guard P-185 não pega porque é chamada interna de `.ps1`, não comando Bash. Risco: re-exposição das 7 credenciais (mesmo vetor do P-185-ROTACAO) + 1.142 arquivos de terceiros empurrados ao Drive a cada fechamento. CORREÇÃO JÁ APLICADA (cirúrgica, espelha verify_gdrive_freshness.ps1 linha 169): adicionados `--exclude awesome-claude-skills-master/**` + `--exclude-from rclone_secrets_exclude.txt`. Parse OK, ASCII puro (0 bytes não-ASCII). Pendente: registrar P-XXX no LEDGER com tag [FALHA-PROCESSO-2026-06-20] após veredito + flag P-098. [RESOLVE: gate10-secrets-exclude]

- [x] `2026-06-16` **[MÚSCULO] P-185-guard REFINO (achado #2) — rclone_secrets_guard não pode dar falso-positivo em `git commit`** [musculo]
  Origem (Dia 16-06-2026 terça-feira): o guard inspeciona o TEXTO INTEIRO do comando Bash. Um `git commit -m "...rclone sync/copy... P-185-guard:"` casou o padrão `palavra:` de destino remoto e BLOQUEOU o próprio commit das 3 atividades de hoje (errei a favor da segurança, mas é ruído). Workaround usado na hora: reescrever a mensagem removendo os tokens-gatilho.
  Refino a construir na sessão de processo: (a) IGNORAR quando o comando é `git`/`git commit`/`git tag`/`git log` (não-rclone — já não deveria casar, mas a mensagem livre engana o regex); (b) idealmente exigir o token de destino remoto DENTRO da própria invocação `rclone` (verbo `rclone (sync|copy)` seguido do `name:` no mesmo segmento), não em qualquer ponto do texto; (c) re-testar os 6 cenários RED/GREEN + um cenário novo: `git commit -m "fala de rclone sync para gdrive:"` → DEVE LIBERAR. Mantém FAIL-OPEN + ASCII puro (P-183). [RESOLVE: P-185-guard-refino]
...
- [x] `2026-06-XX` **[V30 ÉPICO] Máquina de Conhecimento Soberana — canais → FONTES → Auditor → banco gigante** [musculo] ❌ DESCARTADO 2026-06-23 (veredito Diretor) — backlog V30 do Loop 29 descontinuado: com a virada P-194 (modo inteligência de mercado, Loop dormente), a "abertura de versão V30" não está no horizonte. O valor vivo da visão (descoberta de fontes + curadoria firewall) já opera no Cowork Engine + INTELLIGENCE_HUB/SOURCES + W-9 TRENDS — não exige épico próprio. Sai do radar; reabrível só por decisão do Diretor.
...
- [x] `2026-06-XX` **[V30 ÉPICO] Embaixador agentado via Cowork — 2º motor de tempo real (independente de sessão)** [musculo] ❌ DESCARTADO 2026-06-23 (veredito Diretor) — o épico **já está materializado operacionalmente**: o Cowork roda no relógio do mundo (frentes F automáticas + Antigravity COWORK CONDUCTOR), deposita em `INBOX_COWORK` (Drive) e o Músculo COLHE na abertura (gate 0B). Os "dois relógios" (sessão + mundo) já existem (Hermes/n8n + Cowork). Não precisa de épico V30 — foi absorvido. Sai do radar.
...
- [x] `2026-06-XX` **[V30 ÉPICO] Antigravity motor de deriva / W-10 — comandos determinados + repositório de skills** [musculo] ❌ DESCARTADO 2026-06-23 (veredito Diretor) — absorvido: o **Detector de Deriva está ATIVO** (Operação Vault F7, P-196 — `detector_deriva.ps1` orquestra os motores determinísticos + aciona o subagente `doc-drift-audit`, sempre read-only → PENDING_REVIEW) e o **W-10 Health Check** já roda 6h30 BRT. A curadoria de skills do repo Antigravity já tem trilha própria (`awesome-claude-skills` clonado, avaliação sob demanda — item [DIRETOR] acima). Épico V30 redundante. Sai do radar.
...
- [x] `2026-06-18` **[S-2] Telegram avisa para abrir sessão no Músculo quando há tarefa F(x) Cowork pendente de deliberação** [diretor delibera] — ✅ CONSTRUÍDO 2026-06-19: W-13 "Cowork F(x) Notifier" (id `g06fYsG6kxduv7ZA`, cron 07:15 BRT, ATIVO). Runbook RUNBOOK_W13_COWORK_FX.md.
...
- [x] `2026-06-18` **[S-3] Telegram confirma diariamente que os agentes (Antigravity/Cowork/falhas) rodaram** [diretor delibera] — ✅ CONSTRUÍDO 2026-06-19: W-10 Health Check (id `8yvX4MBzdaK5l6IQ`) estendido com resumo POSITIVO 24h (heartbeat dos motores), não só alerta de falha.
  Origem: sugestão do Diretor no Notion (18-06-2026 quinta-feira).
