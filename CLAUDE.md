...
> **Telegram:** `@Eduardo431Vanguardbot` · **Grau atual:** B (age + confirma em 15min no Telegram · D1:A executado 2026-06-10)
...
| W-11 Ativação Manual Notifier | Cron 7:05 BRT (1x/dia) | Notifica Telegram só quando há ativação MANUAL do Diretor hoje — Projetista (Seg triagem · Ter projeção · Sex retroalimentação) · Embaixador Digital (Seg radar · Sex validação); campanha/setup e materialização/agendamento entram sob gatilho. **Opção A (Diretor 2026-06-20): ED NÃO é diário** — radar só Segunda. M-STATS NÃO entra (roda no Músculo/Executor). Fonte de verdade: `scripts/comandos_ativacao_atores.json`. Runbook: `RUNBOOK_W11_ATIVACAO_NOTIFIER.md` · id n8n `vew2fonxWwiGB9uQ` (ATIVO 2026-06-16 terça-feira) |
