...
10. [P-117] Todo diagrama do ciclo Pentalateral deve mostrar os 5 membros (Gemini → NotebookLM → Embaixador → Músculo → Diretor) ou declarar [SUBFLUXO: X] — omissão visual é omissão operacional
```
