...
TEMPO DE RESPOSTA: [imediato / horas / dias / imprevisível]
```
...
[o que o cliente pediu nas primeiras conversas — em aspas se possível]

O QUE REALMENTE QUER:
[o que está por trás do pedido — o medo, a ambição, o problema de ego, a pressão do mercado]

EXEMPLOS:
  "Quero um site moderno" → quer ser levado a sério pelos seus pares
  "Quero automatizar o processo" → quer ter controlo sem depender de pessoas
  "Quero crescer online" → quer provar ao sócio que a ideia dele funciona

O QUE NUNCA VAI DIZER EM VOZ ALTA:
[o que você percebeu mas que o cliente não admite — o medo real, a insegurança, a comparação]
```
...
```
COMO DECIDE:
  [ ] Sozinho, rápido — vai em frente sem precisar de validação
  [ ] Precisa de tempo para pensar — não pressionar
  [ ] Consulta alguém antes de decidir — identificar quem é
  [ ] Decide por comparação — precisa de ver 2 opções
...
O QUE IRRITOU OU CRIOU ATRITO:
[o que causou desconforto em iterações anteriores — mesmo que pequeno]

O QUE CRIOU CONFIANÇA:
[o que fez o cliente sentir-se seguro — entrega rápida, transparência, alerta a tempo, etc.]

FRASES QUE ELE REPETE:
[expressões ou preocupações que surgem várias vezes — são o que mais importa para ele]
```
...
MÉTRICA QUE ELE OBSERVA:
[o número que ele acompanha — vendas, agenda, seguidores, custo, tempo]

O QUE SIGNIFICARIA UMA VITÓRIA PARA ELE:
[o resultado concreto que o faria dizer "foi o melhor investimento que fiz"]
```
...
ROI 30 dias (se disponível): [resultado real]
Estado da relação: [entusiasmado / satisfeito / neutro / frio]
...
2. O NotebookLM vai usar estes dados para calibrar a Skill do Claude
