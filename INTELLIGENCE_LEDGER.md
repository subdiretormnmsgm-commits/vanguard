...
**Anti-recorrencia proposta (P-146 -- documentar sem automatizar = repetir):** dobrar a checagem de ASCII-de-arquivo-inteiro dentro de validate_scripts.ps1 (ou um gate no pre-commit) para todo .ps1 sem BOM staged -- exit != 0 se houver byte > 127. Sem a ferramenta, este principio depende da disciplina do Musculo e vai recorrer. [Pendente de build -- requer veredito do Diretor para entrar no PENDENTES.]
